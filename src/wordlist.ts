/**
 * BIP-39 English wordlist — placeholder for wordchain.
 *
 * This is the unmodified BIP-39 English wordlist (2048 words). It will be
 * curated for spoken clarity (brevity, phonetic distinctiveness) in Task 10.
 * All word derivation logic indexes into this array, so the interface is
 * stable even though the word selection will change.
 */
