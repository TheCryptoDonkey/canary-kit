import{n as e}from"./state-D7iyORQz.js";import{a as t}from"./persona-DtYUYnXJ.js";import{t as n}from"./escape-DiwqE07e.js";import{n as r}from"./persona-picker-j5Uym2Is.js";import{t as i}from"./index-L_xfl-EL.js";var a=3e4,o=`export-modal`;function s(a){document.getElementById(o)?.remove();let s=r(a.name),u=a.displayName??a.name,d=e().settings,f=t(a.name,a.index),p=f.identity.nsec,m=f.identity.npub,h=a.writeRelays?.length?a.writeRelays:d.defaultWriteRelays,g=document.createElement(`dialog`);g.id=o,g.className=`modal export-modal`,g.innerHTML=`
